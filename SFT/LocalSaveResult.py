...
class LocalSaveResult():
    section_str = "Section: Local SaveResult"
    ...
    def Start(self):
	self.log.Print(LocalSaveResult.section_str)
        try:
...
if __name__ == "__main__":
    ...
    if len( args ) != 3:
        sys.exit("Usage: LocalSaveResult.py SerialNumber TestResult TestErrorCode")
    ...
    ffclient = LocalSaveResult(config, log)
