...
class PciSpeedWidthCheck(TestBase):
	...
	self.Ethernet_zt1 = ('d9:00.0', '5', '4', 'Ethernet1')
	self.Ethernet_zt2 = ('d9:00.1', '5', '4', 'Ethernet2')
	self.Ethernet_zt3 = ('d9:00.2', '5', '4', 'Ethernet3')
	self.Ethernet_zt4 = ('d9:00.0', '5', '4', 'Ethernet4')
	self.RAID2 =   ('b1:00.0', '8', '8', 'RAID2')
	self.RAID_s1 =   ('d8:00.0', '8', '8', 'RAID1')
	self.RAID_zt_s1 =   ('5e:00.0', '8', '8', 'RAID1')
        self.LnkStaPatt = \
                r'LnkSta:\W+' + \
    ...
    def Start(self):
		...
		self.Ethernet_zt4 = ('d9:00.0', '5', '4', 'Ethernet4')
	    	...
	    	self.CheckPciSpeedWidth(self.Ethernet_zt3)
	    	self.CheckPciSpeedWidth(self.Ethernet_zt4)
		self.EthernetX70_1 = ('5e:00.0', '8', '8', 'X70_1')
		self.EthernetX70_2 = ('5e:00.1', '8', '8', 'X70_2')
		self.EthernetX70_3 = ('5e:00.2', '8', '8', 'X70_3')
		self.EthernetX70_4 = ('5e:00.3', '8', '8', 'X70_4')
